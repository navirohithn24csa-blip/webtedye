...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="bg-transparent text-[#171717] pb-16 space-y-12 sm:space-y-16">
      {/* ========================================================================= */}
      {/* 1. MODERN LUXURY HERO SECTION (TRANSPARENT GLASS TO SHOWCASE 3D MOTION)  */}
      {/* ========================================================================= */}
      <section className="relative w-full overflow-hidden bg-transparent pt-12 pb-16 lg:pt-20 lg:pb-24 border-b border-black/5">
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center space-y-6">
          
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/85 backdrop-blur-md border border-black/10 shadow-xs">
          ...
          {/* Subtitle */}
          <p className="text-sm sm:text-lg text-[#333333] font-normal leading-relaxed max-w-2xl">
          ...
          <div className="flex flex-wrap justify-center gap-2.5 pt-2 max-w-xl">
            <Link
              ...
              className="text-xs px-4 py-2 rounded-xl bg-white/85 hover:bg-white border border-black/10 font-semibold text-[#171717] transition-all hover:scale-105 shadow-xs"
            >
              ✨ Oversized Baggy
            </Link>
            <Link
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 pt-3">
            ...
            <a
              ...
              className="px-7 py-4 bg-white/90 hover:bg-white text-[#171717] border border-black/10 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-xs flex items-center gap-2 hover:scale-105"
            >
          ...
          {/* Trust Micro-Badges */}
          <div className="grid grid-cols-3 gap-6 sm:gap-12 pt-6 border-t border-black/10 max-w-lg w-full">
            <div>
              <p className="text-base sm:text-lg font-bold text-[#171717]">100%</p>
              <p className="text-[11px] text-[#555555]">Combed Cotton</p>
            </div>
            <div>
              <p className="text-base sm:text-lg font-bold text-[#171717]">220–240 GSM</p>
              <p className="text-[11px] text-[#555555]">Heavyweight Fabric</p>
            </div>
            <div>
              <p className="text-base sm:text-lg font-bold text-[#171717]">Bhavani</p>
              <p className="text-[11px] text-[#555555]">Tamil Nadu Workshop</p>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden bg-[#171717]/95 backdrop-blur-md text-white p-8 sm:p-10 lg:p-12 shadow-xl border border-white/10">
      ...
      {/* ========================================================================= */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden bg-white/80 backdrop-blur-md p-6 sm:p-8 rounded-3xl border border-black/10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
          {/* Left Info with Circle Icon */}
          <div className="flex items-center gap-4 text-left">
            <div className="w-12 h-12 rounded-full bg-white/95 backdrop-blur-md flex items-center justify-center text-[#171717] shrink-0 border border-black/10 shadow-xs">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-start md:justify-end">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-3 bg-white hover:bg-slate-50 text-[#171717] border border-black/10 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-xs flex items-center gap-2 hover:scale-105"
            >
              <MessageCircle className="w-4 h-4 text-emerald-600" />
